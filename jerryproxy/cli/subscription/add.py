...
When no source option is supplied in guided mode, the wizard offers matching
environment variables (names only; values stay hidden), direct secret URL
input, a file path, or bounded stdin. Custom environment-name input completes
against the matching variables visible in the current process.
